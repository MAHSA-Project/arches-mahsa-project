"""
Django settings for mahsa_project project.
"""
...
ELASTICSEARCH_PREFIX = 'mahsa_project'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'mahsa_project.search_indexes.sample_index.SampleIndex',
...
SESSION_COOKIE_NAME = 'mahsa_project'
